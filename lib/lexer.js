module.exports = {
  pseudoPhrase: function(input, stopwords) {
    ...
    // todo: detect urls and strip them out
    // Remove some non-alphabetical characters (numbers and punctuation)
    // Strip the lowercase string of numbers and periods
    ...
    var noPunctuationInput = noNumberInput.replace(/[\.,-\/#!$?%\^&\*;:{}=\-_`"~()<>\[\]]/g, " ");//.replace(/\./ig, "");
    ...
    //todo: Implement porter2 stemming algorithm @sprint2 (4)
